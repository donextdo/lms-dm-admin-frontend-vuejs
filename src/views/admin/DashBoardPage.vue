<template>
  <div class="dashboard-wrapper">
    <div class="analytics d-flex flex-column">
      <v-card
        :height="laptop ? '180px' : '236px'"
        :width="laptop ? '360px' : '450px'"
        flat
        class="card-lg"
      >
        <div class="combo-box">
        ...
        <h2 class="data">
          {{
            studentType == "Local"
              ...
              ? studentCount.global
              : studentCount.local + studentCount.global
          }}
        </h2>
      </v-card>
        ...
        <h2 class="data">
          {{
            classType == "Local"
              ...
              ? classesCount.global
              : classesCount.local + classesCount.global
          }}
        </h2>
      </v-card>
    </div>
    ...
    <div class="classes">
      <div class="dashbord-sub-topic">Upcoming Classes Today</div>
    ...
    <div class="requests">
      <div class="dashbord-sub-topic">New Student Requests</div>
      ...
      <div class="requests-wrapper d-flex flex-column">
        <Request
          v-for="(student, index) in joinRequests"
  ...
  methods: {
    ...
    async refreshRequests() {
      ...
      const { data } = await axios.get(
        `${this.$hostname}/api/admin/refreshRequests`
      );
      this.loader = false;
      this.joinRequests = data.data.requests.student;
      this.closeProfile();
