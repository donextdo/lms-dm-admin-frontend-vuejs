<template>
    <v-card :height="laptop ? '80px' : '110px'" width="100%" flat class="card">
      ...
      <h4 class="d-flex align-center">Date</h4>

          <h4 class="d-flex align-center">Grade</h4>
        <a class="d-flex align-center" style="color:red; font-weight:bold;">Send Reminder <svg  style="margin-left:4%;" width="9" height="15" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0.5 12.5L5.5 7.5L0.5 2.5L1.5 0.5L8.5 7.5L1.5 14.5L0.5 12.5Z" fill="#FE3F49"/>
  ...
  <style scoped>
      ...
      .card {
          padding: 25px 30px;
          display: grid;  
          grid-template-columns:48% 17% 20% 15%;    
      }
