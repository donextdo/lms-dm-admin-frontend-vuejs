<template>
  <div flat class="v">
    <ButtonVue
      v-if="role == 1"
      style="margin-top: 4%; width: max-content"
      text="new User"
      @click="save"
    />
    ...
    <div class="row card mt-6">
      <div class="col-6">
        <h3>User Profile</h3>
        <p>
          Upload your profile details.<br />
          PNG, SVG or GIF (Maximum file size 50MB)
        </p>
      </div>
      <div class="right" cols="auto">
        ...
        <div @click="upload()" class="img2">
          <v-avatar :size="laptop ? '20px' : '18px'">
            ...
            >
              <path
                d="M20.2161 3.87391H17.3987L14.4495 0.924688C14.3485 0.82332 14.2284 0.742929 14.0963 0.688144C13.9641 0.63336 13.8223 0.605262 13.6792 0.60547H9.32132C9.17822 0.605262 9.0365 0.63336 8.9043 0.688144C8.77211 0.742929 8.65205 0.82332 8.55105 0.924688L5.60183 3.87391H2.78443C1.58273 3.87391 0.605469 4.85118 0.605469 6.05287V18.0372C0.605469 19.2389 1.58273 20.2161 2.78443 20.2161H20.2161C21.4178 20.2161 22.3951 19.2389 22.3951 18.0372V6.05287C22.3951 4.85118 21.4178 3.87391 20.2161 3.87391ZM11.5003 16.9477C8.54779 16.9477 6.05287 14.4528 6.05287 11.5003C6.05287 8.54778 8.54779 6.05287 11.5003 6.05287C14.4528 6.05287 16.9477 8.54778 16.9477 11.5003C16.9477 14.4528 14.4528 16.9477 11.5003 16.9477Z"
                fill="#272937"
                fill-opacity="0.5"
              />
            </svg>
        ...
        <ButtonVue
          :transparent="true"
          class="mt-3 ml-1"
          style="width: max-content; font-size: 14px"
          text="Remove Photo"
    ...
    <div class="row">
      <div class="col-7" style="margin-left: 11.5%">
        <ButtonVue
          :transparent="true"
          style="width: max-content; font-size: 14px;"
          text="Reset Password"
      ...
      <div class="col-11">
        <ButtonVue
          style="margin-left: 3%; width: max-content"
          text="Save Changes"
          @click="save"
        />
        <ButtonVue
...
export default {
  ...
  created() {
    this.set_data(), (this.role = sessionStorage.getItem("role"));
  },
  methods: {
    upload() {
    ...
    async save() {
      ...
      const { data } = await this.user
        .post(this.$hostname + "/api/resetInfo")
        .then((response) => {
          this.loader = false;
          this.data = data.data;
          if (this.data) {
