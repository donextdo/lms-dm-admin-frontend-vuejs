            ...
            <div class="details d-flex flex-column">
                ...
                <div class="data">
                    ...
                    <div class="block">
                        ...
                        <p class="value" v-for="(item, index) in info.subject"  :item="item" :key="index"  v-show="type==='student'">{{item.name}}</p>
                        <p class="value" v-show="type==='tutor'">{{info.subject.name}}</p>
                    </div>
                    <div class="block">
                        <p class="key">{{ type === 'tutor' ? 'Grades Taught' : 'Grade'}}</p>
                        <p class="value" v-for="(item, index) in info.grade" :item="item" :key="index"  >{{item.name,}}</p>
                    </div>
                </div>
            </div>
