<template>
  <header class="navbar">
    ...
    <div
      ...
      @click="$router.go(-1)"
    >
      <pre>    >    {{ className.getters.topic }}   >   Recording Link</pre>
    </div>
    <v-btn
      @click="payments"
      v-if="role == 3"
      ...
      :height="laptop ? '40px' : '50px'"
      elevation="0"
      class="btn rounded-lg admin-data"
      ><svg
        width="30"
        height="21"
        viewBox="0 0 30 21"
